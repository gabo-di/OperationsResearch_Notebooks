...
#blending constraint
@constraint(model, [month in Months], sum( refined_oilmonth[month,oil]*hardness_oils[oil] for oil in Oils ) <= hardness_max_oilmix*sum(refined_oilmonth[month,:]) )
@constraint(model, [month in Months], sum( refined_oilmonth[month,oil]*hardness_oils[oil] for oil in Oils ) >= hardness_min_oilmix*sum(refined_oilmonth[month,:]) )
